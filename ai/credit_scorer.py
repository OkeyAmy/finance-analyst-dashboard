...
class AICreditScorer:
    def __init__(self, output_dir: str = "credit_analysis_outputs"):
        ...
        # Weights for small business focus
        self.weights = {
    ...
    def convert_to_dataframe(self, file_path: Union[str, Path]) -> Tuple[pd.DataFrame, str]:
        ...
        if file_path.suffix.lower() == '.pdf':
            ...
            Date,Description,Debit,Credit,Balance. Make sure to know the start balance before the first transaction.
    ...
    def _process_audio_purpose(self, business_name: str, purpose: Union[str, Path], file_path: Union[str, Path]) -> str:
        ...
        3. Make sure to extract the user's local currency symbol and any other relevant information.
        ...
        Transcribe the provided audio and extract key information related to the business. 
        Specifically, determine if the business faces local competition, identify its current profit margins, 
        and fill in any missing details using available financial data if the user has not provided all the necessary information. 
        If both the audio and financial data have missing information unrelated to these key points, do not add anything
        """
    ...
    def _generate_small_business_analysis(self, business_name: str, 
        ...
        Always base your decisions and recommendations on the provided metrics. 
        Refer to these metrics as much as possible when making your analysis, 
        and ensure you consistently reference the business purpose information {purpose} throughout. 
        Your reasoning should be grounded in the data available, and your suggestions should align with the context provided by the business purpose and relevant metrics.
        ...
        7. Operational Efficiency
              - Streamlining processes for better financial performance
        ...
        - Conduct a financial analysis based on the extracted business information from the audio and use it to provide actionable insights, focusing on the following areas:  
        - Revenue and Income Patterns  
        ...
        Format the analysis in a clear, actionable way that is useful for both small and informal business owners. 
        Focus on practical, implementable suggestions without using complex financial terminology. 
        Always recommend the user seek professional advice, but do not imply that your analysis is inaccurate. 
        Ensure the business purpose information extracted from the audio file is included. While the primary focus should be on the above points, 
        feel free to provide additional insights based on all available information, but organize it logically and clearly.
        """
    ...
    def calculate_score(self, data: pd.DataFrame, business_name: str, purpose: Union[str, Path], file_path: Union[str, Path], audio_purpose_path: Union[str, Path]) -> Tuple[int, str, str, Dict, str]:
        ...
        try:
            ...
            processed_purpose = self._process_audio_purpose(business_name=business_name, 
            purpose=audio_purpose_path, file_path=text_file)
    ...
    def analyze_financial_data(self, file_path: Union[str, Path], 
        ...
        try:
            ...
            if save_output:
                raw_filename_base = f"{business_name.replace(' ', '_')}_{file_path.stem}"
                filename_base = sanitize_filename(raw_filename_base)
